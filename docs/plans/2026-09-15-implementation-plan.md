...
公開済み: [全体計画 #1](https://github.com/romashito-ueda/enegaeru_biz_poc/issues/1) — 親1件、PoC本体12件、後続2件。

登録先: https://github.com/romashito-ueda/enegaeru_biz_poc
...
- [ ] [T00](../issues/2026-09-15/T00.md) — 既存PoCを取り込み、開発・検証の開始点を揃える（M0 / P0 / S）
- [ ] [T01](../issues/2026-09-15/T01.md) — 入出力契約・前提条件・時系列と検証用データを定義する（M1 / P0 / M）
- [ ] [T02](../issues/2026-09-15/T02.md) — Python計算サービスと非同期ジョブの実行基盤を作る（M1 / P0 / M）
- [ ] [T03](../issues/2026-09-15/T03.md) — 太陽光の方位・傾斜・PCS・経年計算をPySAMへ移す（M1 / P0 / L）
- [ ] [T04](../issues/2026-09-15/T04.md) — 蓄電池・20年運転・電力由来と残量の整合を実装する（M2 / P0 / L）
- [ ] [T05](../issues/2026-09-15/T05.md) — 年次収支・追加NPV・費用条件を共通評価へ接続する（M2 / P0 / M）
- [ ] [T06](../issues/2026-09-15/T06.md) — UIを非同期計算へ切り替え、保存データと結果の版を管理する（M2 / P0 / M）
- [ ] [T07](../issues/2026-09-15/T07.md) — 住所から屋根確認・発電ポテンシャルへ進む導線を作る（M1→M3 / P1 / M）
- [ ] [T08](../issues/2026-09-15/T08.md) — 顧客条件から設備候補を探索し、条件に強い案を選ぶ（M3 / P1 / L）
- [ ] [T09](../issues/2026-09-15/T09.md) — 推奨案に影響する次の確認項目を選び、回答で再評価する（M3 / P1 / L）
- [ ] [T10](../issues/2026-09-15/T10.md) — 候補比較・推奨理由・次の確認を一つの提案画面に統合する（M3 / P1 / M）
- [ ] [T11](../issues/2026-09-15/T11.md) — 計算・提案・質問の受入検証と処理時間を記録する（M4 / P0 / M）
- [ ] [F01](../issues/2026-09-15/F01.md) — 条件が成立する境界と最小限の条件変更を示す（後続 / P2 / M）
- [ ] [F02](../issues/2026-09-15/F02.md) — 住所・屋根・気象の実データ取得を検証して接続する（後続 / P2 / L）
